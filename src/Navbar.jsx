      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between p-2">
          <div className="flex items-center">
            <a href="#" className="flex text-3xl font-text font-semibold text-black">
              Temse
            </a>
          </div>
          ...
          <a href="#" className="font-medium mr-5 font-text text-black text-base">Login</a>
          ...
          <div className="lg:hidden">
            <button onClick={toggleMenu} className="inline-flex items-center justify-center p-2 rounded-md text-black" aria-label="Toggle menu">
      ...
      >
        <div className="flex text-start flex-col h-full">
          <div className="flex justify-between text-start items-center p-4 border-b">
            ...
            <button onClick={toggleMenu} className="p-2 rounded-md text-black" aria-label="Close menu">
